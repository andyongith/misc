...
function BackButton({ action, children, className = "", ...props }) {
    return <img
        ...
        alt="back"
        onClick={action}
        className={'cursor-pointer bg-primary/10 p-2 rounded-xl absolute' + className}
        {...props}
    />
}
...
export default function Login() {
    ...
    return <div className='
        flex justify-center items-center w-screen h-screen bg-primary/15 dark:bg-dark/90
    '>
        <main className="
            w-sm h-fit bg-light dark:bg-dark/50 rounded-3xl shadow-[0px_0px_20px]
            shadow-primary/50 p-10
        ">
